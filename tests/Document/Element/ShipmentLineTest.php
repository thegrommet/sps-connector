...
class ShipmentLineTest extends TestCase
{
    public function testExportToXml(): void
    {
        ...
        $line->orderedQty = 40;
        $line->orderedQtyUOM = $line::PRICE_BASIS_EACH;
        ...
        $this->assertSame($line::PRICE_BASIS_EACH, (string)$xml->ShipmentLine->OrderQtyUOM);
        ...
        $this->assertSame($line::PRICE_BASIS_EACH, (string)$xml->ShipmentLine->ShipQtyUOM);
    }
